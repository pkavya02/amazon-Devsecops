pipeline {
    ...
    stages {
        ...
        stage("Git Checkout") {
            steps {
                git branch: 'main', url: 'https://github.com/pkavya02/amazon-Devsecops.git'
            }
        }
            ...
            steps {
                script {
                    withCredentials([string(credentialsId: 'docker-cred', variable: 'dockerpwd')]) {
                        sh "docker login -u pkavya555 -p ${dockerpwd}"
    ...
    always {
        script {
            ...
            emailext (
                ...
                """,
                to: 'kavyapolisetti222@gmail.com',
                from: 'kavyapolisetti222@gmail.com',
                mimeType: 'text/html',
